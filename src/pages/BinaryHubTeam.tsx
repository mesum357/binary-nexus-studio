...
import { Home, Users, ImageIcon, ArrowLeft, Moon, Sun, Linkedin, ExternalLink } from "lucide-react";
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-foreground/70 max-w-2xl mx-auto">
              Meet the talented individuals who drive innovation and excellence at Binary Hub. 
                ...
                `}>
                  ...
                  <div className="relative p-8 text-center">
                    ...
                    <div className={`
                      ...
                      ${hoveredMember === member._id ? "scale-110 rotate-3" : ""}
                    `}>
                      {/* Animated border */}
                      <div className={`
                    ...
                    <h3 className={`
                      ...
                      ${hoveredMember === member._id ? "text-white" : "text-foreground"}
                    `}>
                      {member.name}
                    </h3>
                    ...
                    <p className={`
                      ...
                      ${hoveredMember === member._id ? "text-white/80" : "text-muted-foreground"}
                    `}>
                      {member.designation}
                    </p>
