...
import { ArrowLeft, Moon, Sun, MapPin } from "lucide-react";
...
const BranchDetail = () => {
    ...
    const branch = seedData.binaryHubBranches?.find((b) => b.id === branchId);
        ...
        <div className="min-h-screen bg-background text-foreground">
                ...
                <div className="relative z-10 h-full container mx-auto px-4 flex flex-col justify-end pb-12">
                    ...
                    >
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-lg text-white font-medium drop-shadow">{branch.location}</span>
                        </div>
            ...
            <section className="py-20 container mx-auto px-4">
                <div className="max-w-5xl mx-auto">
                    ...
                    >
                        <h2 className="text-3xl font-bold mb-8 gradient-text text-center">Gallery</h2>
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {branch.images.map((img, idx) => (
                                <motion.div
                                    ...
                                    className="relative group overflow-hidden rounded-3xl aspect-[4/3] shadow-xl"
                                >
                                    <img
                                        src={img}
                                        alt={`${branch.name} image ${idx + 1}`}
